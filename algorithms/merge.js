...
function skybox(){
	...
	var cubeMaterials = [
	    new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load( "http://github.com/sruzek/sruzek.github.io/blob/master/images/skybox/posx.jpg" ), side: THREE.DoubleSide }), //front side
